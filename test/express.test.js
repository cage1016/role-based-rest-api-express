...
describe('express rest api server available only to the users with an specific permissions', function(){
  it('checks if an users without the proper permissions (create-an-object)', function(done){
    superagent.get('http://localhost:3000/api/v1/create_an_object?token=' + token)
      .end(function(e, res){
         // console.log(res.body);
         expect(e).to.eql(null);
         expect(res.body.success).to.eql(true);
  ...
  it('checks if an users without the proper permissions (create-a-non-object)', function(done){
    superagent.get('http://localhost:3000/api/v1/create_a_non_object?token=' + token)
      .end(function(e, res){
         // console.log(res.body);
         expect(e).to.eql(null);
         expect(res.body.success).to.eql(false);
